using System.Text;
using AdminLogApi.Src.Shared.Application.Configuration;
using AdminLogApi.Src.Shared.Infrastructure.Queue.Dtos;
using Newtonsoft.Json;
using RabbitMQ.Client;
using RabbitMQ.Client.Events;

namespace AdminLogApi.Src.Shared.Infrastructure.Queue.Adapters;
